...
def _bootstrap_database_if_needed() -> None:
    ...
    for statement in (
        ...
        # DEFAULT TRUE => les comptes existants gardent boutique+resto (migration). Les nouveaux
        # profils crees par l'ORM utilisent le defaut Python (False) => Premium part decoche.
        "ALTER TABLE seller_profiles ADD COLUMN IF NOT EXISTS offers_shop BOOLEAN DEFAULT TRUE",
        ...
        "ALTER TABLE restaurant_reservations ADD COLUMN IF NOT EXISTS deposit_amount DOUBLE PRECISION DEFAULT 0",
        "ALTER TABLE restaurant_reservations ADD COLUMN IF NOT EXISTS deposit_payment_method VARCHAR(20)",
        "ALTER TABLE restaurant_reservations ADD COLUMN IF NOT EXISTS transaction_reference VARCHAR(180)",
        "ALTER TABLE restaurant_reservations ADD COLUMN IF NOT EXISTS payment_status VARCHAR(20) DEFAULT 'paid'",
        "ALTER TABLE hotel_bookings ADD COLUMN IF NOT EXISTS payment_status VARCHAR(20) DEFAULT 'paid'",
